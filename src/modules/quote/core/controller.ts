/*
  ...
  recalcula y vuelve a pintar. Copiado sin cambios desde portafolio: no
  depende de marca ni de idioma (mountQuote sigue recibiendo `lang` porque
  format.ts lo necesita para el locale numérico).
*/
import {
  clampCounter,
  computeQuote,
...
export function mountQuote(root: HTMLElement, data: QuoteData, lang: Lang): void {
  ...
  /** «2 páginas · $150», o «$75 c/u» mientras el contador está en cero. */
